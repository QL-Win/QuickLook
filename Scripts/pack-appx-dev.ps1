...
if(-not (Test-Path env:CI))
{
    ...
    # generate resources
    $priExe = 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.22000.0\x86\makepri.exe'
    .$priExe new /pr ..\Build\Appx /cf ..\Build\priconfig.xml /of ..\Build\Appx\resources.pri
    
    # packing
    $packExe = 'C:\Program Files (x86)\Windows Kits\10\bin\10.0.22000.0\x86\makeappx.exe'
    $folder = '..\Build\Appx\'
